...
#if defined(LUA_CORE)
#include <math.h>
#define luai_numband(a,b)   ((unsigned long)(a) & (unsigned long)(b))
#define luai_numbor(a,b)    ((unsigned long)(a) | (unsigned long)(b))
#define luai_numbxor(a,b)   ((unsigned long)(a) ^ (unsigned long)(b))
#define luai_numbshl(a,b)   ((unsigned long)(a) << (unsigned long)(b))
#define luai_numbshr(a,b)   ((unsigned long)(a) >> (unsigned long)(b))
#define luai_numbnot(a)     (~(unsigned long)(a))   
