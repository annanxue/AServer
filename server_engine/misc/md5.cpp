...
static void Encode(unsigned char *, unsigned long *, unsigned long);
static void Decode(unsigned long *, unsigned char *, unsigned long);
static void MD5_memcpy(unsigned char *, unsigned char *, unsigned long);
static void MD5_memset(unsigned char *, int, unsigned long);
...
static void MD5_memcpy (unsigned char * output, unsigned char * input, unsigned long len)
{
	unsigned long i;
...
static void MD5_memset (unsigned char *output, int value, unsigned long len)
{
	unsigned long i;
	for (i=0; i<len; i++)
