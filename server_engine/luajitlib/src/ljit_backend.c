...
static void jit_compile_irange(jit_State *J, int firstpc, int lastpc)
{
  ...
  while (J->nextpc <= lastpc) {
	...
	*J->mfm++ = JIT_MFM_DEAD;
    ...
    case OP_BAND: jit_op_arith(J, ra, rb, rc, TM_BAND); break;
    case OP_BOR: jit_op_arith(J, ra, rb, rc, TM_BOR); break;
    case OP_BXOR: jit_op_arith(J, ra, rb, rc, TM_BXOR); break;
    case OP_BSHL: jit_op_arith(J, ra, rb, rc, TM_BSHL); break;
    case OP_BSHR: jit_op_arith(J, ra, rb, rc, TM_BSHR); break;
    case OP_BNOT: jit_op_arith(J, ra, rb, rb, TM_BNOT); break;
